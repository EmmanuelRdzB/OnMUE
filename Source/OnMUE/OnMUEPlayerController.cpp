...
void AOnMUEPlayerController::BeginPlay()
{
	...
	if (ShouldUseTouchControls() && IsLocalPlayerController())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogOnMUE, Error, TEXT("Could not spawn mobile controls widget."));
...
void AOnMUEPlayerController::SetupInputComponent()
{
...
bool AOnMUEPlayerController::ShouldUseTouchControls() const
{
